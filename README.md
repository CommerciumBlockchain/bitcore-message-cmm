...
bitcore-message-cmm adds support for verifying and signing Commercium messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-cmm
```

```sh
bower install bitcore-message-cmm
```
...
var Message = require('bitcore-message-cmm');
